                ...
                <div key={index} className="border border-gray-200 dark:border-gray-600 rounded-lg p-3 sm:p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 flex items-center mt-1">
                    ...
                    <div className="text-left sm:text-right text-xs sm:text-sm text-gray-500 dark:text-gray-400">
